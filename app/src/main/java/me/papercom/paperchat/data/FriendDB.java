package me.papercom.paperchat.data;
...
public final class FriendDB {
    ...
    // Untuk mencegah seseorang  memberi tahu kelas kontrak,
    // buat konstruktor private
    private FriendDB() {
    }
    ...
    public long addFriend(Friend friend) {
        ...
        //  buat maps value baru, kunci pake nama tabel
        ...
        //Buat row baru, return primary key
    ...
    /* Inner class untuk konten tabel */
    ...
    private static class FriendDBHelper extends SQLiteOpenHelper {
        // Jika ganti database schema, ganti juga versinya
